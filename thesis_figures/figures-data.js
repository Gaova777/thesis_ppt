...

{
  ...
  data:[
    {f1:0.2075, mcc:0.2694, passed:false},
    {f1:0.2935, mcc:0.2693, passed:false},
    {f1:0.0259, mcc:-0.0092, passed:false},
    {f1:0.2983, mcc:0.2803, passed:false},
    {f1:0.1597, mcc:0.1299, passed:false},
    {f1:0.0022, mcc:0.0080, passed:false},
    {f1:0.4380, mcc:0.4409, passed:true},
    {f1:0.0041, mcc:-0.0007, passed:false},
    {f1:0.0087, mcc:0.0651, passed:false},
    {f1:0.2490, mcc:0.2311, passed:false},
    {f1:0.0022, mcc:0.0089, passed:false},
    {f1:0.0000, mcc:0.0000, passed:false},
    {f1:0.1995, mcc:0.2669, passed:false},
    {f1:0.3261, mcc:0.3205, passed:true},
    {f1:0.4595, mcc:0.4436, passed:true},
    {f1:0.3148, mcc:0.3103, passed:true},
    {f1:0.2908, mcc:0.2721, passed:false},
    {f1:0.2163, mcc:0.1889, passed:false},
    {f1:0.4785, mcc:0.4672, passed:true},
    {f1:0.5295, mcc:0.5196, passed:true},
    {f1:0.4714, mcc:0.4538, passed:true},
    {f1:0.2633, mcc:0.2412, passed:false},
    {f1:0.3077, mcc:0.2955, passed:true},
    {f1:0.3774, mcc:0.3679, passed:true},
    {f1:0.3150, mcc:0.2955, passed:true},
    {f1:0.2031, mcc:0.2491, passed:false},
    {f1:0.2449, mcc:0.3102, passed:false},
    {f1:0.2145, mcc:0.2479, passed:false},
    {f1:0.0870, mcc:0.0902, passed:false},
    {f1:0.1926, mcc:0.2226, passed:false},
    {f1:0.3434, mcc:0.3834, passed:true},
    {f1:0.2616, mcc:0.3285, passed:false},
    {f1:0.3623, mcc:0.4020, passed:true},
    {f1:0.2676, mcc:0.2451, passed:false},
    {f1:0.2474, mcc:0.2939, passed:false},
    {f1:0.2676, mcc:0.2451, passed:false},
    {f1:0.2525, mcc:0.2654, passed:false, native:true},
    {f1:0.3232, mcc:0.3029, passed:true,  native:true},
    {f1:0.3070, mcc:0.2842, passed:true,  native:true},
    {f1:0.1437, mcc:0.1124, passed:false, native:true},
    {f1:0.2113, mcc:0.1847, passed:false, native:true},
    {f1:0.1949, mcc:0.1666, passed:false, native:true},
    {f1:0.5262, mcc:0.5136, passed:true,  native:true},
    {f1:0.5254, mcc:0.5130, passed:true,  native:true},
    {f1:0.3593, mcc:0.4050, passed:true,  native:true},
    {f1:0.2695, mcc:0.2473, passed:false, native:true},
    {f1:0.4302, mcc:0.4316, passed:true,  native:true},
    {f1:0.0000, mcc:0.0000, passed:false, native:true},
    {f1:0.3150, mcc:0.2944, passed:true},
    {f1:0.4199, mcc:0.4006, passed:true},
    {f1:0.2593, mcc:0.2583, passed:false},
    {f1:0.2973, mcc:0.3068, passed:false},
    {f1:0.0746, mcc:0.1139, passed:false},
    {f1:0.1349, mcc:0.1433, passed:false},
    {f1:0.5166, mcc:0.5067, passed:true},
    {f1:0.5226, mcc:0.5115, passed:true},
    {f1:0.2540, mcc:0.2329, passed:false},
    {f1:0.2549, mcc:0.2362, passed:false},
    {f1:0.3097, mcc:0.2971, passed:true},
    {f1:0.0000, mcc:0.0000, passed:false}
  ]
},
